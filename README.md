...
Почти вся работа заключается в реализации sprintf и sscanf. Поэтому распишу их функционал подробнее.
Спецификаторы для sprintf и sscanf:  
...
### Полученные навыки:
- Навыки работы со строками и понимания форматированного ввода-вывода
- Навык парсинга данных
- Рефакторинг
- Практические навыки реализации низкоуровневых функций с учетом работы с памятью, указателями, буферами и безопасностью данных.
- Улучшение навыков чтения и анализа официальной документации стандарта языка С, а также сопутствующей литературы по системному программированию.
- Умение писать оптимальный и переносимый код на С, подходящий для работы на разных платформах без использования сторонних библиотек.
  
## Запуск проекта
Цели через Makefile:
make — сборка string.h в виде статической библиотеки
make test — запуск unit-тестов
make gcov_report — генерация и отображение отчёта о покрытии через gcov

## Список тем для дальнейшего изучения:
- Создать свой тип данных в С
- Изучить бинарные математические операции на самом низком уровне
- Изучить схему работы различных операторов и приведения типов
